...
const SearchPage = ({ photos = [], albums = [], onPhotoClick, refreshData }) => {
  ...
  const handleMovePhotos = async (targetAlbumId) => {
    try {
      ...
      const selectedIds = selectedPhotos.map((sp) =>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <label className="flex items-center gap-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setActiveFilters((f) => ({ ...f, albumId: e.target.value || null }))
                }
            ...
            <label className="flex items-center gap-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setActiveFilters((f) => ({ ...f, category: e.target.value || null }))
                }
                className="flex-1 bg-transparent border border-white/10 rounded-lg px-3 py-2"
              >
            ...
            <label className="flex items-center gap-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setActiveFilters((f) => ({ ...f, dateRange: e.target.value || null }))
                }
                className="flex-1 bg-transparent border border-white/10 rounded-lg px-3 py-2"
              >
