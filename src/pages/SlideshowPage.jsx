...
export default function SlideshowPage() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black flex flex-col">
      {/* Top Bar */}
      <header
        className={`slideshow-header fixed top-0 inset-x-0 z-[10000] h-14 bg-black/85 backdrop-blur-xl transition-opacity duration-300 text-on-glass ${
      ...
      <main className="flex-1 flex items-center justify-center p-0">
        {photo.type === 'document' ? (
          <div className="flex flex-col items-center justify-center gap-4 p-8 text-white">
            ...
            <p className="text-white/60">Documents cannot be shown in slideshow</p>
            <a
              href={photo.url}
              download={photo.name}
