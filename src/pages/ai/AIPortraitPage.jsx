// ============================================================================
// AIPortraitPage - AI Portrait Enhancement (Phase 5: Mock)
// ============================================================================
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-pink-900 to-slate-900">
        <header className="fixed top-0 inset-x-0 z-50 h-14 bg-black/40 backdrop-blur-md border-b border-white/10">
          <div className="flex items-center justify-between px-4 h-full">
            ...
            <h1 className="text-white font-semibold">{t('ai:portrait')}</h1>
            <div className="w-10" />
          </div>
        </header>
        ...
        <main className="pt-20 pb-8 px-4">
          <div className="max-w-md mx-auto text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">{t('ai:portrait')}</h2>
            <p className="text-white/60 mb-6">{t('ai:portraitDesc')}</p>
