// ============================================================================
// COMPONENT: AlbumCard.jsx – Twilight Theme med 3D Tilt Effect
// ============================================================================
    ...
    >
      {coverUrl ? (
        <img
          ...
          className="album-thumb object-contain bg-gradient-to-br from-gray-900 to-indigo-900"
          loading="lazy"
        />
      ) : (
        <div
          className="album-thumb flex items-center justify-center text-gray-400 bg-gradient-to-br from-gray-900 to-indigo-900"
        >
          <svg
